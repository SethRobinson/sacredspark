...
//To play an mp3 that was added with teh audioclip method below:

  RTMessageManager.Get().Schedule(1, RTAudioManager.Get().PlayMusic, "playing_music", 0.3f, 1.0f, true);
